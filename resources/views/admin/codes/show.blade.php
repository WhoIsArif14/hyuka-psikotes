    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="mb-4">
                    <a href="{{ route('admin.codes.index') }}" class="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold">{{ $batchCodes->where('status', 'Pending')->count() }} kode</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase border-r">Nama Pengguna</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase border-r">Tanggal Digunakan</th>
                                
                                {{-- ✅ TAMBAH HEADER KOLOM TRACK --}}
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Track Pengerjaan</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm font-mono font-semibold border-r text-blue-600">{{ $item->code }}</td>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-800">
                                    @if($item->user && ($item->status === 'Used' || $item->status === 'On Progress'))
                                        ...
                                        <div class="text-xs font-medium text-gray-600 truncate" title="{{ $currentStep }}">
