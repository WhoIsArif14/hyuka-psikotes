                    ...
                    <form method="POST" action="{{ route('admin.alat-tes.update', $AlatTes->id) }}">
                        ...
                        <div>
                            ...
                            <input id="name"
                                ...
                                type="text" name="name" value="{{ old('name', $AlatTes->name) }}" required autofocus />
                            @error('name')
                        ...
                        <div class="mt-4">
                            ...
                            <input id="duration_minutes"
                                ...
                                type="number" name="duration_minutes" value="{{ old('duration_minutes', $AlatTes->duration_minutes) }}" required />
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="example_1_options" rows="4"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                        placeholder="Jakarta&#10;Bandung&#10;Surabaya&#10;Medan&#10;Bali">{{ old('example_1_options', isset($examples[0]['options']) ? implode("\n", $examples[0]['options']) : '') }}</textarea>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="example_2_question" 
                                        value="{{ old('example_2_question', $examples[1]['question'] ?? '') }}"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="example_2_options" rows="4"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                        placeholder="1&#10;2&#10;3&#10;4&#10;5">{{ old('example_2_options', isset($examples[1]['options']) ? implode("\n", $examples[1]['options']) : '') }}</textarea>
                                    <p class="mt-1 text-xs text-gray-500">Setiap baris = 1 pilihan jawaban</p>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="example_2_explanation" 
                                            value="{{ old('example_2_explanation', $examples[1]['explanation'] ?? '') }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                            placeholder="Penjelasan jawaban...">
                                    </div>
                                </div>
