                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.alat-tes.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="duration_minutes" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" type="number" name="duration_minutes" value="{{ old('duration_minutes') }}" required />
                        </div>
