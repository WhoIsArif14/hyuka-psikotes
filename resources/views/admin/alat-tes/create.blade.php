                            ...
                            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
                                <div class="flex items-start gap-3">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-yellow-800 mt-1">Instruksi dan contoh soal sekarang dikelola di halaman <strong>Kelola Soal</strong> setelah alat tes dibuat. Silakan klik tombol "Kelola Soal" pada daftar Alat Tes untuk menambahkan instruksi dan contoh soal.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
