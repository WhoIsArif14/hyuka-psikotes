            ...
            <div class="mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <nav class="text-sm breadcrumbs mt-2">
                            <ul class="flex space-x-2 text-gray-600">
                                ...
                                <li>/</li>
                                <li><a href="{{ route('admin.tests.index') }}" class="hover:text-blue-600">Modul Tes</a></li>
                                <li>/</li>
                                <li><a href="{{ route('admin.tests.show', $test->id) }}" class="hover:text-blue-600">{{ $test->title }}</a></li>
                                <li>/</li>
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.tests.show', $test->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md">
                            <i class="bi bi-arrow-left mr-2"></i> Kembali ke Detail
                        </a>
                        <a href="{{ route('admin.tests.export', $test->id) }}" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            <strong class="text-gray-800">{{ $result->participant_name ?? $result->user->name ?? '-' }}</strong>
                                        </td>
                                        <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-600">
