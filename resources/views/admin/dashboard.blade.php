<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Aktivitas Pengerjaan Tes Terbaru -->
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                            ...
                            @forelse ($recentResults as $result)
                                <tr>
                                    <td class="px-6 py-4">
                                        ...
                                        {{-- Tampilkan nama dari akun jika ada, jika tidak, tampilkan dari data pendaftaran --}}
                                        {{ $result->user->name ?? $result->participant_name }}
                                    </td>
