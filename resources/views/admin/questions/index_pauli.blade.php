            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p class="text-sm text-blue-800">
                        <strong>💡 Tentang Pauli Test:</strong> Test ini mengukur kecepatan kerja, ketepatan, dan
                        konsistensi.
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if ($test->generated_questions_count > 0)
                                                    <span class="px-2 py-1 text-xs rounded bg-green-50 text-green-700">
                                                        Tersimpan: {{ $test->generated_questions_count }}
                                                    </span>
                                                @endif
                                            </div>
                                        </td>
