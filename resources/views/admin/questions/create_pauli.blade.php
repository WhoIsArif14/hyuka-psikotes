<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ route('admin.pauli.index') }}" 
                    ...
                    <form method="POST" 
                            ...
                            <select id="alat_tes_id" 
                                ...
                                @foreach($alatTes as $alat)
                                    <option value="{{ $alat->id }}" 
                                            {{ old('alat_tes_id', $pauliTest->alat_tes_id ?? '') == $alat->id ? 'selected' : '' }}>
                                        {{ $alat->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="total_columns" 
                                   name="total_columns" 
                                   value="{{ old('total_columns', $pauliTest->total_columns ?? 45) }}"
                                   min="1"
                                   max="60"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="pairs_per_column" 
                                   name="pairs_per_column" 
                                   value="{{ old('pairs_per_column', $pauliTest->pairs_per_column ?? 45) }}"
                                   min="1"
                                   max="60"
                                   ...
                                   required>
                            <p class="mt-1 text-sm text-gray-500">Jumlah pasangan angka per kolom (1-60). Default: 45</p>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('time_per_column', $pauliTest->time_per_column ?? 60) }}"
                                   min="10"
                                   max="300"
                                   ...
                                   required>
                            <p class="mt-1 text-sm text-gray-500">Waktu yang diberikan per kolom dalam detik (10-300). Default: 60</p>
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <ul class="list-disc list-inside space-y-1">
                                            <li>Total soal: <strong><span id="totalQuestions">2025</span></strong> soal</li>
                                            <li>Total waktu: <strong><span id="totalTime">45</span></strong> menit</li>
                                            <li>Durasi per soal: <strong><span id="timePerQuestion">1.3</span></strong> detik</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            ...
                            <p class="text-sm text-gray-600">
                                Pauli Test adalah tes psikologi yang mengukur kecepatan, ketepatan, dan konsistensi kerja seseorang. 
                                Test ini terdiri dari penjumlahan angka-angka yang harus diselesaikan dalam waktu terbatas.
                            </p>
                        </div>
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                            ...
                            <button type="submit" 
                                ...
                                {{ isset($pauliTest) ? 'Update Test' : 'Simpan Test' }}
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                ...
                const timePerQuestion = totalQuestions > 0 ? ((totalColumns * timePerColumn) / totalQuestions).toFixed(1) : 0;
