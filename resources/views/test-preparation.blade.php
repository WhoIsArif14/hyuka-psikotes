                        ...
                        @if (isset($exampleQuestions[0]))
                            <div class="bg-gray-50 rounded-lg p-6 mb-4">
                                ...
                                @if (($ex['type'] ?? '') === 'PAPIKOSTICK')
                                    <div class="space-y-3">
                                        <label
                                            class="flex items-start p-4 bg-white rounded-lg border-2 cursor-pointer transition-all duration-200 border-gray-200 hover:border-indigo-300 hover:bg-indigo-50">
