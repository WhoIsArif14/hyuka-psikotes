...
class PapiKostickItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['item_number' => 12, 'statement_a' => 'Saya tidak mudah marah', 'statement_b' => 'Saya dapat membuat orang lain melakukan apa yang saya inginkan', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ...
            ['item_number' => 22, 'statement_a' => 'Saya menata pekerjaan dengan baik', 'statement_b' => 'Saya seorang pemimpin yang baik', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 23, 'statement_a' => 'Saya lambat dalam membuat keputusan', 'statement_b' => 'Saya mudah marah', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ...
            ['item_number' => 32, 'statement_a' => 'Detail (hal-hal kecil) menarik buat saya', 'statement_b' => 'Saya memimpin kelompok', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 33, 'statement_a' => 'Saya menyimpan barang-barang secara rapi dan teratur', 'statement_b' => 'Saya membuat keputusan mudah dan cepat', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ['item_number' => 34, 'statement_a' => 'Saya jarang marah atau sedih', 'statement_b' => 'Saya membuat keputusan dengan mudah dan cepat', 'role_a' => 'T', 'need_a' => 'X', 'role_b' => 'G', 'need_b' => 'X'],
            ...
            ['item_number' => 42, 'statement_a' => 'Saya berpikir hati-hati dan lama', 'statement_b' => 'Orang lain berpendapat bahwa saya pemimpin yang baik', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 43, 'statement_a' => 'Saya suka cerewet mengenai hal-hal yang kecil', 'statement_b' => 'Saya sering memanfaatkan kesempatan', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ['item_number' => 44, 'statement_a' => 'Orang lain berpendapat bahwa saya menyimpan segala sesuatu secara teratur dan rapi', 'statement_b' => 'Orang lain berpendapat bahwa saya bekerja cepat', 'role_a' => 'T', 'need_a' => 'X', 'role_b' => 'G', 'need_b' => 'X'],
            ['item_number' => 45, 'statement_a' => 'Saya sangat menyenangkan', 'statement_b' => 'Saya menyukai permainan dan olah raga', 'role_a' => 'V', 'need_a' => 'B', 'role_b' => 'G', 'need_b' => 'B'],
            ...
            ['item_number' => 52, 'statement_a' => 'Saya mudah berteman', 'statement_b' => 'Saya tipe seorang pemimpin', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 53, 'statement_a' => 'Saya banyak sekali berpikir', 'statement_b' => 'Saya memanfaatkan kesempatan', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ['item_number' => 54, 'statement_a' => 'Saya senang menangani pkerjaan detail', 'statement_b' => 'Saya bekerja dengan tempo yang cepat dan mantap', 'role_a' => 'T', 'need_a' => 'X', 'role_b' => 'G', 'need_b' => 'X'],
            ['item_number' => 55, 'statement_a' => 'Saya menyimpan segala sesuatu secara rapi dan teratur', 'statement_b' => 'Saya memiliki banyak tenaga untuk permainan dan olah raga', 'role_a' => 'V', 'need_a' => 'B', 'role_b' => 'G', 'need_b' => 'B'],
            ['item_number' => 56, 'statement_a' => 'Saya berwatak tenang', 'statement_b' => 'Saya bergaul dengan semua orang', 'role_a' => 'S', 'need_a' => 'O', 'role_b' => 'G', 'need_b' => 'O'],
            ...
            ['item_number' => 62, 'statement_a' => 'Saya terampil menggunakan peralatan', 'statement_b' => 'Apabila saya berbicara, kelompok menyimak', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 63, 'statement_a' => 'Saya lambat dalam mengambil keputusan', 'statement_b' => 'Saya lambat dalam berteman', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ['item_number' => 64, 'statement_a' => 'Saya senang membaca', 'statement_b' => 'Saya biasanya makan dengan cepat', 'role_a' => 'T', 'need_a' => 'X', 'role_b' => 'G', 'need_b' => 'X'],
            ['item_number' => 65, 'statement_a' => 'Saya menyukai pekerjaan yang harus saya kerjakan secara hati-hati', 'statement_b' => 'Saya menyukai pekerjaan yang membuat saya bergerak', 'role_a' => 'V', 'need_a' => 'B', 'role_b' => 'G', 'need_b' => 'B'],
            ['item_number' => 66, 'statement_a' => 'Saya dapat menemukan sesuatu yang telah saya sisihkan', 'statement_b' => 'Saya berteman dengan sebanyak mungkin orang', 'role_a' => 'S', 'need_a' => 'O', 'role_b' => 'G', 'need_b' => 'O'],
            ['item_number' => 67, 'statement_a' => 'Saya selalu menyenangkan', 'statement_b' => 'Saya merencana jauh dimuka', 'role_a' => 'R', 'need_a' => 'Z', 'role_b' => 'G', 'need_b' => 'Z'],
            ...
            ['item_number' => 72, 'statement_a' => 'Saya biasa sangat tergesa-gesa', 'statement_b' => 'Kelompok biasanya melaksanakan keinginan saya', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 73, 'statement_a' => 'Saya lambat dalam membuat keputusan', 'statement_b' => 'Saya senang merasa lelah', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ['item_number' => 74, 'statement_a' => 'Saya mudah berteman', 'statement_b' => 'Saya bekerja cepat', 'role_a' => 'T', 'need_a' => 'X', 'role_b' => 'G', 'need_b' => 'X'],
            ['item_number' => 75, 'statement_a' => 'Saya mnggunakan banyak wakru unruk berpikir', 'statement_b' => 'Saya biasanya bersemangat atau bergairah', 'role_a' => 'V', 'need_a' => 'B', 'role_b' => 'G', 'need_b' => 'B'],
            ['item_number' => 76, 'statement_a' => 'Saya menyukai pekerjaan yang menuntut ketelitian', 'statement_b' => 'Saya sangat ramah terhadap orang lain', 'role_a' => 'S', 'need_a' => 'O', 'role_b' => 'G', 'need_b' => 'O'],
            ['item_number' => 77, 'statement_a' => 'Saya menyimpan segala sesuatu pada tempatnya', 'statement_b' => 'Saya banyak berpikir dan merencana', 'role_a' => 'R', 'need_a' => 'Z', 'role_b' => 'G', 'need_b' => 'Z'],
            ['item_number' => 78, 'statement_a' => 'Saya tidak cepat marah', 'statement_b' => 'Saya menyukai pekerjaan yang menuntut hal-hal yang mendetail', 'role_a' => 'D', 'need_a' => 'K', 'role_b' => 'G', 'need_b' => 'K'],
            ...
            ['item_number' => 82, 'statement_a' => 'Saya suka bersenang-senang', 'statement_b' => 'Saya membuat orang lain bekerja keras', 'role_a' => 'L', 'need_a' => 'A', 'role_b' => 'G', 'need_b' => 'A'],
            ['item_number' => 83, 'statement_a' => 'Saya berbicara cepat', 'statement_b' => 'Saya membuat keputusan dengan cepat', 'role_a' => 'I', 'need_a' => 'P', 'role_b' => 'G', 'need_b' => 'P'],
            ['item_number' => 84, 'statement_a' => 'Saya berolah raga secara teratur', 'statement_b' => 'Saya biasanya bekerja secara tergesa-gesa', 'role_a' => 'T', 'need_a' => 'X', 'role_b' => 'G', 'need_b' => 'X'],
            ['item_number' => 85, 'statement_a' => 'Saya cepat lelah', 'statement_b' => 'Saya tidak suka bertemu orang-orang lain', 'role_a' => 'V', 'need_a' => 'B', 'role_b' => 'G', 'need_b' => 'B'],
            ['item_number' => 86, 'statement_a' => 'Saya menggunakan banyak waktu untuk berpikir', 'statement_b' => 'Saya berteman dengan banyak sekali orang', 'role_a' => 'S', 'need_a' => 'O', 'role_b' => 'G', 'need_b' => 'O'],
            ['item_number' => 87, 'statement_a' => 'Saya suka melaksanakan pekerjaan detail', 'statement_b' => 'Saya suka bekerja dengan teori', 'role_a' => 'R', 'need_a' => 'Z', 'role_b' => 'G', 'need_b' => 'Z'],
            ['item_number' => 88, 'statement_a' => 'Saya suka mengatur pekerjaan saya', 'statement_b' => 'Saya suka melaksanakan pekerjaan detail', 'role_a' => 'D', 'need_a' => 'K', 'role_b' => 'G', 'need_b' => 'K'],
            ['item_number' => 89, 'statement_a' => 'Saya selalu menyenangkan', 'statement_b' => 'Saya meletakkan segala sesuatu pada tempatnya', 'role_a' => 'C', 'need_a' => 'F', 'role_b' => 'G', 'need_b' => 'F'],
        ...
        foreach ($items as $item) {
            // Hanya simpan role (role_a, role_b). Hapus keys 'need_a' dan 'need_b' jika ada.
            unset($item['need_a'], $item['need_b']);
